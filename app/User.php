...
class User extends Authenticatable
{
    ...
    {
       //return $this->belongsToMany('App\Question', 'favorites','user_id','question_id');
       return $this->belongsToMany('App\Question', 'favorites')->withTimestamps();
    }

    public function voteQuestions()
    {
        return $this->morphedByMany('App\Question','votable'); //singular form pivot table name
    }

    public function voteAnswers()
    {
        return $this->morphedByMany('App\Answer','votable'); //singular form pivot table name
    }
    ...
    private function _vote($relationShip, $model, $vote)
    {
        ...
        $model->load('votes'); //to refresh the votes relationship
